  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      try {
        ...
        const resClient = await axios.get('http://localhost:5000/dashboard/client', {
        ...
        <div className="grid-container">
          ...
          {/* Invoices */}
            <div className="card">
              <img
                className="card-image"
                src="https://plus.unsplash.com/premium_photo-1679784204535-e623926075cb?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8aW52b2ljZXxlbnwwfHwwfHx8MA%3D%3D?w=800&q=80&auto=format&fit=crop"
                alt="Invoices"
              />
            <div className="card-content">
              <h3>Invoices</h3>
